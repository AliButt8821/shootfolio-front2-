    ...
    <div className='exploringgamesectionbg'>
        <Container>
            <Row>
                <Col md={4}></Col>
                <Col md={4}>
                     <p className='Exploringheading'>Play Game</p>
                     </Col>
            ...
            <Row className='marg-top-100-gamemodes'>
                ...
                <Col md={3}>
                    <div   className='maketennisrow'>
                        ...
                        <p className='statusgame'>Coming Soon</p>
                        <Button className='Freetoplaybutton mt-5'><span className='gameplayicngreen'><BsFillPlayFill/></span>Free to play?</Button>
                    </div>
                </Col>
                <Col md={3}>
                    <div   className='maketennisrow'>
